        ...
        <form action="{{ route('audit.update', $audit->id) }}" method="POST">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-auto">
                        <input type="text" name="lokasi" placeholder="Lokasi Audit" class="form-control form-control-sm"
                            value="{{old('lokasi',$audit->lokasi)}}" disabled required>
                    </div>
                </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <select name="sarana_id" class="form-control form-control-sm" disabled required>
                            ...
                            <option value="{{ $sarana->id }}"
                                {{ $audit->sarana_id == $sarana->id ? 'selected' : null }}>{{ $sarana->nama }} </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-sm-2"> <br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="text" name="user_id" placeholder="Nama Pemeriksa"
                            class="form-control form-control-sm" value="{{old('user_id',$audit->user->name)}}" disabled
                            required>
                    </div>
                </div>
                <div class="row">
