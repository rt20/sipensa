...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <form class="form-inline ml-3">
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" type="text" name="search" placeholder="Cari" aria-label="Search" value="{{old('search')}}">
...
<!-- Navbar Right Menu coba copy dari employee-->
