			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				@csrf
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is required">
                        ...
                        <input type="text" class="input100 @error('email') is-invalid @enderror" 
                                    name="login" placeholder="NIP" value="{{ old('login') }}" required autocomplete="email" autofocus>
                                    @error('login')
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
                        ...
                        <input id="password" type="password" class="input100 @error('password') is-invalid @enderror" placeholder="Kata Sandi" name="password" required autocomplete="current-password">
					...
					<div class="text-right p-t-8 p-b-31" >
						<a href="#" title="Silakan hubungi admin SIPENSA">
							Lupa Kata Sandi?
						</a>
					</div>
